...
<head>
	...
	<!-- profits -->
	<link rel="stylesheet" href="assets/css/profits.css" />
				...
				<div class="container-fluid">
					<div class="">
						<div class="profits-div">
							<div class="profits-div-hdr">
								<p class="profits-div-hdr-text">
									الرصيد والارباح
								</p>
							</div>
							<div class="profits-div-body">
								<div class="row">
										...
										<div class="payWay-div">
											<div class="row">
												<div class="col-lg-4 col-md-12 col-sm-12">
													<div class="col-div">
														<div class="col-hdr">
															<p><b>الرصيد الكلي</b></p>
														</div>
														<div class="col-body">
															<div class="priceText">
																<p><span><b>1222 ريال</b></span></p>
															</div>
															<p class="infoPriceTexr">كامل الرصيد الموجود في حسابك الآن
																يتضمن الارباح والرصيد المتعلق ايضاً</p>
														</div>
													</div>
												</div>
												<div class="col-lg-4 col-md-12 col-sm-12">
													<div class="col-div">
														<div class="col-hdr">
															<p><b>الرصيد المعلق</b></p>
														</div>
														<div class="col-body">
															<div class="priceText">
																<p><span><b>1222 ريال</b></span></p>
															</div>
															<p class="infoPriceTexr">يتم تعليق الأرباح التى حفظتها لمدة
																14 يومًا قبل ان تتمكن من استخدامها</p>
														</div>
													</div>
												</div>
												<div class="col-lg-4 col-md-12 col-sm-12">
													<div class="col-div">
														<div class="col-hdr">
															<p><b>ارباح يمكنك استخدامها </b></p>
														</div>
														<div class="col-body">
															<div class="priceText">
																<p><span><b>1222 ريال</b></span></p>
															</div>
															<p class="infoPriceTexr">ارباحك يمكنك استخدامها الى حسابك في
																PayPal</p>
														</div>
													</div>
												</div>
