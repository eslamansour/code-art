...
<head>
	...
	<!-- order-application -->
	<link rel="stylesheet" href="assets/css/order-application.css" />
...
<body>
	...
	<section>
		<div class="section-order-application">
			<div class="order-application">
				<div class="container-fluid">


					<div class="">
						<div class="order-application-div">
							<div class="order-application-div-hdr">
								<p class="order-application-div-hdr-text">
									نموذج البيانات
								</p>
							</div>
							<div class="order-application-div-body">
								<form class="needs-validation" id="signupForm" novalidate action="payment.html">
									<div class="item">
										<div class="row">
											<div class="col-lg-4 col-md-4 col-sm-12">
												<div class="form-group">
													<label for="username-form" class="data-cell-label-title"> اسم الشركة
														<span class="required-star"><sup>*</sup></span></label>
													<input type="text" class="form-control txtBox-name"
														id="order-app-form-name" value="" required>
													<div class="invalid-feedback invalid-lbl"> اسم الشركة مطلوب </div>
												</div>
											</div>
											<div class="col-lg-4 col-md-4 col-sm-12">
												<div class="form-group">
													<label for="username-form" class="data-cell-label-title"> العنوان
														<span class="required-star"><sup>*</sup></span></label>
													<input type="text" class="form-control txtBox-name"
														id="order-app-form-address" value="" required>
													<div class="invalid-feedback invalid-lbl"> العنوان مطلوب </div>
												</div>
											</div>
											<div class="col-lg-4 col-md-4 col-sm-12">
												<div class="form-group">
													<label for="country-form" class="data-cell-label-title"> سنة الانشاء
													</label>
													<!-- delete required to not valid it -->
													<select class="form-control txtBox-name selectOption"
														id="order-app-form-date">
														<option selected hidden></option>
														<option>2010</option>
														<option>2011</option>
													</select>
													<div class="invalid-feedback invalid-lbl"> </div>
												</div>
											</div>
										</div>
										<div class="btn-submit-div pb-20">
											<button class="btn btn-primary btn-submit" type="submit">متابعه</button>
