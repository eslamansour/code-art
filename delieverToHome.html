...
<head>
	...
	<!-- delieverToHome -->
	<link rel="stylesheet" href="assets/css/delieverToHome.css" />
...
<body>
	...
	<section>
		<div class="section-delieverToHome">
			<div class="delieverToHome">
				<div class="container-fluid">


					<div class="">
						<div class="delieverToHome-div">
							<div class="delieverToHome-div-hdr">
								<p class="delieverToHome-div-hdr-text">
									عنوان الشحن
								</p>
							</div>
							<div class="delieverToHome-div-body">
								<div id="map"></div>
							</div>
						</div>
						<div class="row">
							<div class="col-lg-12">
								<div class="btn-submit-div pb-20">
									<a class="btn btn-primary btn-submit" href="addressInformation.html">
										<button class="btn " style="color:white; font-weight:bold"
											type="submit">متابعه</button>
									</a>
								</div>
							</div>
						</div>
