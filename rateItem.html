...
<head>
	...
	<!-- rateItem -->
	<link rel="stylesheet" href="assets/css/rateItem.css" />
											...
											<div class="rateItem-div-body address-col">
												<div class="row">
													...
													<div class="rate-div mt-10">
														<textarea class="form-control txtBox-name" rows="5" placeholder="اكتب رأيك وتعليقك عن المنتج" value=""></textarea>
													</div>
													</div>
												</div>
												<div class="btn-submit-div pb-20">
													<button class="btn btn-primary btn-submit" onclick="submitRating()"
														type="button">تقييم</button>
												</div>
											</div>
										</div>
									</div>
