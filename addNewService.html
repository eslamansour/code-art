...
<head>
    ...
    <!-- addNewService -->
    <link rel="stylesheet" href="assets/css/addNewService.css" />
</head>
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item ">
                    <a class="nav-link" href="#"><i class="nav-link-icon fas fa-headset"></i>
    ...
    <section>
        <div class="addNewService">
            <div class="container">
                <div>
                    <p>
                        <h5 class="hdr-page" style="text-align: center;"><b>قم باختيار الخدمة التي تريدها</h5>
                    </p>
                </div>
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-6 addNewService-item-col">
                        <div class="addNewService-item-div">
                            <a class="addNewService-item-href-div" href="addServiceOfCategory.html">
                                <div class="addNewService-item addNewService-item-1">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 addNewService-item-col">
                        <div class="addNewService-item-div">
                            <a class="addNewService-item-href-div" href="addServiceOfCategory.html">
                                <div class="addNewService-item addNewService-item-2">
                                    <img src="./assets/imgs/services-item-2.png" />
                                    <div class="item-info">
                                        <p class="item-name">
                                            <b>تصميم مواقع</b>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 addNewService-item-col">
                        <div class="addNewService-item-div">
                            <a class="addNewService-item-href-div" href="addServiceOfCategory.html">
                                <div class="addNewService-item addNewService-item-3">
                                    <img src="./assets/imgs/services-item-2.png" />
                                    <div class="item-info">
                                        <p class="item-name">
                                            <b>تصميم مواقع</b>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 addNewService-item-col">
                        <div class="addNewService-item-div">
                            <a class="addNewService-item-href-div" href="addServiceOfCategory.html">
                                <div class="addNewService-item addNewService-item-4">
                                    <img src="./assets/imgs/services-item-2.png" />
                                    <div class="item-info">
                                        <p class="item-name">
                                            <b>تصميم مواقع</b>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 addNewService-item-col">
                        <div class="addNewService-item-div">
                            <a class="addNewService-item-href-div" href="addServiceOfCategory.html">
                                <div class="addNewService-item addNewService-item-5">
                                    <img src="./assets/imgs/services-item-2.png" />
                                    <div class="item-info">
                                        <p class="item-name">
                                            <b>تصميم مواقع</b>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 addNewService-item-col">
                        <div class="addNewService-item-div">
                            <a class="addNewService-item-href-div" href="addServiceOfCategory.html">
                                <div class="addNewService-item addNewService-item-6">
                                    <img src="./assets/imgs/services-item-2.png" />
                                    <div class="item-info">
                                        <p class="item-name">
                                            <b>تصميم مواقع</b>
