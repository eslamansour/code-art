	...
	<section>
		<div class="fav-div-hdr">
			<p class="fav-div-hdr-text">
				عربة التسوق &nbsp;&nbsp; &nbsp;&nbsp; <span class="fav-count">(3) منتج</span>
			</p>
		</div>
									...
									<div class="row">
										...
										<div class="col-lg-5 col-md-6 col-sm-6 col-xs-12 div-2">
											<div class="data-cell col-data-3 ">
												...
												<label class="data-cell-label-details fav-date">21-1-2019</label>
											</div>
										</div>
									...
									<div class="row">
										...
										<div class="col-lg-2 col-md-6 col-sm-6 div-2-4">
											<div class="data-cell mt-3">
												<button class="btn fav-action-btn"><i class="fas fa-heart"></i>
