...
<body>
		...
		<div class="section-settings">
			<div class="settings">
				<div class="container-fluid">
					...
					<div class="">
						<form class="needs-validation" id="profileForm" novalidate action="addressConfirm.html">
															...
															<div class="data-cell">
																<div class="form-group">
																	...
																	<input type="text" class="form-control txtBox-name"
																		id="name-accountData" value="" required>
															...
															<div class="data-cell">
																<div class="form-group">
																	...
																	<input type="email" class="form-control txtBox-name"
																		id="email-accountData" value="a@ads.com"
																		required>
															...
															<div class="data-cell">
																<div class="form-group">
																	...
																	<input type="number"
																		...
																		id="phone-accountData" value="23" required>
												...
												<div class="row">
													<div class="address-col-info">
														<div class="col-lg-12 col-md-12 col-sm-12">
															<div class="data-cell">
																<div class="form-group">
																	<label for="country-accountData"
																		class="data-cell-label-title"> الدولة</label>
																	<select
																		class="form-control txtBox-name selectOption"
																		onchange="countryChange()"
																		id="country-accountData" required>
																		<option selected hidden></option>
																		<option>مصر</option>
																		<option>المملكة العربية السعودية</option>
																	</select>
																	<div class="invalid-feedback invalid-lbl"> اختر
																		الدولة </div>
																</div>
															</div>
														</div>
												...
												<div class="row">
													<div class="address-col-info">
														<div class="col-lg-12 col-md-12 col-sm-12">
															<div class="data-cell">
																<div class="form-group">
																	<label for="city-accountData"
																		class="data-cell-label-title"> المدينة</label>
																	<select
																		class="form-control txtBox-name selectOption"
																		id="city-accountData" required>
																		<option selected hidden></option>
																	</select>
																	<div class="invalid-feedback invalid-lbl"> اختر
																		المدينه </div>
		...
		<div class="modal fade" id="passwordPopup" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
			...
			<div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content">
					<form class="needs-validation" id="profilePasswordForm" novalidate>
								...
								<div class="row">
									...
									<div class="col-lg-12 col-md-12 col-sm-12">
										<div class="form-group">
											...
											<input type="password" class="form-control txtBox-name" id="password"
												value="" required>
											<div class="invalid-feedback invalid-lbl"> كلمة المرور
												مطلوبة</div>
										</div>
	...
	<script>
		...
		function countryChange() {
			var selectedCountry = $("#country-accountData").val();
			$('#city-accountData').find('option').remove().end().append('<option selected hidden></option>');

			if (selectedCountry == "مصر") {
				$('#city-accountData').append(`<option value="مصر 1"> 
					مصر 1 
				</option>`);
				$('#city-accountData').append(`<option value="مصر 1"> 
					مصر 1 
				</option>`);
				$('#city-accountData').append(`<option value="مصر 3"> 
					مصر 3 
				</option>`);
			}
			if (selectedCountry == "المملكة العربية السعودية") {
				$('#city-accountData').append(`<option value="السعودية 1"> 
					السعودية 1 
				</option>`);
				$('#city-accountData').append(`<option value="السعودية 1"> 
					السعودية 1 
				</option>`);
				$('#city-accountData').append(`<option value="السعودية 3"> 
					السعودية 3 
				</option>`);
			}
		}
