...
<head>
	...
	<!-- addressInformation -->
	<link rel="stylesheet" href="assets/css/addressInformation.css" />
...
<body>
	...
	<section>
		<div class="section-addressInformation">
			<div class="addressInformation">
				<div class="container-fluid">


					<div class="">
						<form class="needs-validation" id="signupForm" novalidate action="addressConfirm.html">
							<div class="addressInformation-div">
								<div class="addressInformation-div-hdr">
									<p class="addressInformation-div-hdr-text">
										تفاصيل العنوان
									</p>
								</div>
								<div class="addressInformation-div-body">

									<div class="row">
										<div class="col-lg-6 col-md-12 col-sm-12">
											<div class="address-col">
												<h5><b>معلومات الموقع</b></h5>
												<div class="row">
													<div class="col-lg-12 col-md-12 col-sm-12">
														<div class="address-col-info">
															<span><i class="fas fa-map-marker-alt ml-3"></i>القاهرة -
																الهرم</span>
														</div>
													</div>
													<div class="col-lg-12 col-md-12 col-sm-12">
										...
										<div class="col-lg-6 col-md-12 col-sm-12">
											<div class="address-col2">
												<h5><b>المعلومات الشخصية</b></h5>
												<div class="row">
													<div class="address-col-info">
														<div class="col-lg-12 col-md-12 col-sm-12">
															<div class="data-cell">
																<div class="form-group">
																	<label for="addressInformationForm-name"
																		class="data-cell-label-title">
																		اسم المستخدم</label>
																	<input type="text" class="form-control txtBox-name"
																		id="addressInformationForm-name" value=""
																		required>
														...
														<div class="col-lg-12 col-md-12 col-sm-12">
															<div class="data-cell">
																<div class="form-group">
																	<label for="addressInformationForm-phone"
																		class="data-cell-label-title">رقم
																		الجوال </label>
																	<input type="number"
																		class="form-control txtBox-name"
																		id="addressInformationForm-phone" value=""
																		required>
