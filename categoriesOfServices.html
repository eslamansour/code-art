...
<head>
	...
	<!-- categoriesOfServices-page -->
	<link rel="stylesheet" href="assets/css/categoriesOfServices-page.css" />
</head>
			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item active">
					...
					<div class="dropdown-menu nav-link-dropdown" aria-labelledby="dropdownMenuLink">
						<a class="dropdown-item" href="categoriesOfcategoriesOfServices.html"><i
		...
		<div class="container-fluid">
			<div class="section-row new-categoriesOfServices">
				<div class="section-hdr">
					<h3 class="section-hdr-txt"><b> تصميم</b></h3>
				...
				<div class="row">
					<div class="col-lg-4 col-md-4 col-sm-6 service-page-item-col">
						<div class="service-page-item-div">
							<a class="service-page-item-href-div" href="services.html">
