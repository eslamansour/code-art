...
<head>
	...
	<!-- phoneConfirm -->
	<link rel="stylesheet" href="assets/css/phoneConfirm.css" />
...
<body>
	...
	<section>
		<div class="section-phoneConfirm">
			<div class="phoneConfirm">
				<div class="container-fluid">


					<div class="">
						<form class="needs-validation" id="phoneCode" novalidate>
							<div class="phoneConfirm-div">
								<div class="phoneConfirm-div-hdr">
									<p class="phoneConfirm-div-hdr-text">
										تأكيد رقم الهاتف
									</p>
								</div>
								<div class="">
									...
									<div class="row">
										<div class="col-lg-12 col-md-12 col-sm-12">
											<div class="phoneConfirm-div-body address-col">

												<div class="address-col-info">
													<span><span class="info-title-data">برجاءادخال رمز التأكيد الذي تم
															ارساله الى جوالك</span></span>
												</div>
												<div class="data-cell">
													<div class="form-group">
														<input type="text" class="form-control txtBox-name"
															id="phoneCode-form" value="" required>
														<div class="invalid-feedback codeInvalid invalid-lbl">
															الكود المطلوب </div>
													</div>
												</div>
							...
							<div class="row">
								<div class="col-lg-12">
									<div class="btn-submit-div pb-20">
										<button class="btn btn-primary btn-submit" onclick="submitPhone()"
											type="button">متابعه</button>
									</div>
								</div>
							</div>
						</form>
