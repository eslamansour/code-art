...
<head>
	...
	<!-- addressConfirm -->
	<link rel="stylesheet" href="assets/css/addressConfirm.css" />
...
<body>
	...
	<section>
		<div class="section-addressConfirm">
			<div class="addressConfirm">
				<div class="container-fluid">


					<div class="">
						<form class="needs-validation" id="signupForm" novalidate action="phoneConfirm.html">
							<div class="addressConfirm-div">
								<div class="addressConfirm-div-hdr">
									<p class="addressConfirm-div-hdr-text">
										تفاصيل العنوان
									</p>
								</div>
								<div class="">
									...
									<div class="row">
										<div class="col-lg-6 col-md-12 col-sm-12">
											<div class="addressConfirm-div-body address-col">
												<div class="row">
													<div class="col-lg-12 col-md-12 col-sm-12">
														<div class="address-col-info">
															<span><span class="info-title ml-5">الاسم </span><span
																	class="info-title-data">القاهرة -
																	الهرم</span></span>
														</div>
														<div class="address-col-info">
															<span><span class="info-title ml-5">العنوان </span><span
																	class="info-title-data">القاهرة -
																	الهرم</span></span>
														</div>
														<div class="address-col-info">
															<span><span class="info-title ml-5">رقم الجوال </span><span
																	class="info-title-data">القاهرة -
																	الهرم</span></span>
														</div>
													</div>
										...
										<div class="col-lg-6 col-md-12 col-sm-12">
											<div class="address-col2">
												<div class="address-col-info">
													<a href="addressInformation.html">
														<div><b><i class="fas fa-plus-circle ml-3"></i>اضافة عنوان
																جديد</b></div>
													</a>
												</div>
											</div>
